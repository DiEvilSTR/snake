...
const game1 = new (0, _snake.Snake)();
const game2 = new (0, _snake.Snake)();
game1.init();
game2.init();
console.log("Snake.canvasHeight", (0, _snake.Snake).canvasHeight); // console.log('game', game2);
...
},{"./Snake":"9hQq7"}],"9hQq7":[function(require,module,exports) {
...
},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequire46ba")
